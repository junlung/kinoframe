...
ActiveRecord::Schema[7.1].define(version: 2024_10_29_221211) do
  ...
  create_table "movie_list_items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["movie_id"], name: "index_movie_list_items_on_movie_id"
    t.index ["movie_list_id"], name: "index_movie_list_items_on_movie_list_id"
  end
  ...
  add_foreign_key "movie_list_items", "movie_lists"
  add_foreign_key "movie_list_items", "movies"
